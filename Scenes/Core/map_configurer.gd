...
func load_data():
	...
	$InfoDatThingy/MarginContainer/VBoxContainer/PanelContainer8/HBoxContainer2/PrevviewStartContainer/PreviewStartSpinBox.value = map_data_manager.get_property(&"preview_start")
	$InfoDatThingy/MarginContainer/VBoxContainer/PanelContainer8/HBoxContainer2/PreviewDurationContainer/HBoxContainer/PreviewDurationSpinBox.value = map_data_manager.get_property(&"preview_duration")
