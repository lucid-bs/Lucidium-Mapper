...
@export var note_jump_start_beat_offset : float = 0
...
var conversion_table_to_json = {
	...
	"note_jump_start_beat_offset" = "_noteJumpStartBeatOffset",
...
func unpack_from_json(json_text : String, json : Dictionary = {}) -> DifficultyBeatmap:
	...
	note_jump_start_beat_offset = raw_data[conversion_table_to_json["note_jump_start_beat_offset"]]
